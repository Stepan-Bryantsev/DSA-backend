...
export const createProjectValidation = [
  ...
  body("startDate", "Wrong startDate").optional().isDate(),
  body("endDate", "Wrong endDate").optional().isDate(),
  body("applicationDeadline", "Wrong applicationDeadline").optional().isDate(),
